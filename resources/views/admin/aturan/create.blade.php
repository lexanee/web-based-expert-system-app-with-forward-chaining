<x-app-layout>
    <x-slot name="title">
        Tambah Aturan | Admin Panel Sistem Pakar IOTACE
    </x-slot>
    <x-slot name="header">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.aturan.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_aturan" id="kode_aturan" value="{{ old('kode_aturan') }}"
                                placeholder="Contoh: R1, R2, R3"
                            ...
                            <select name="masalah_id" id="masalah_id"
                                ...
                                @foreach ($masalah as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('masalah_id') == $item->id ? 'selected' : '' }}>

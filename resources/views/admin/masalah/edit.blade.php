<x-app-layout>
    <x-slot name="title">
        Edit Masalah | Admin Panel Sistem Pakar IOTACE
    </x-slot>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.masalah.update', $masalah) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_masalah" id="kode_masalah"
                                value="{{ old('kode_masalah', $masalah->kode_masalah) }}"
                                placeholder="Contoh: M1, M2, M3"
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_masalah" id="nama_masalah"
                                value="{{ old('nama_masalah', $masalah->nama_masalah) }}"
                        ...
                        <div>
                            ...
                            <textarea name="solusi" id="solusi" rows="5" placeholder="Masukkan solusi untuk masalah ini..."
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('solusi', $masalah->solusi) }}</textarea>
                            @error('solusi')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
